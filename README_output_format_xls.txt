...
This document describes the format of water quality data provided as *.xls or
*.csv files by the GEMS/Water Data Center. 
...
were visible in the data portal. Water quality data with RESTRICTED data policy 
...
Each of the water quality sample data tables have the following entries:
	...
	Remark							- Some more or less intelligible remarks,
